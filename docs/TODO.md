...
- [ ] **JPEG modal missing Cancel on initial upload**
...
- [ ] **Export button hidden below scroll fold**
...
- [ ] **Upload zone not keyboard/screen-reader accessible**
...
- [ ] **Shape buttons missing `aria-pressed`**
...
- [ ] **Export button has no accessible loading state**
...
- [ ] **Shape tiles show static gray — don't reflect actual logo**
...
- [ ] **Background swatch shows white when transparent is active**
...
- [ ] **"Upload a different image" reads as destructive**
...
- [ ] **Score metric bars give no improvement guidance**
...
- [ ] **Empty right panel on first load**
...
- [ ] **Two uppercase section headers stacked in right panel**
...
- [ ] **Controls sections have no visual separation**
...
- [ ] **Trust signal "Free · No account needed" too small**
...
- [ ] **MobileBrowserPreview constrained to w-1/2 in narrow panel**
...
- [ ] **Color input has no accessible label**
